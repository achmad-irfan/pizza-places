...
<pI work as an analyst for the Pizza Place restaurant. My boss asked you to analyze the restaurant's performance in 2015 </p>
<h3>Purpose:</h3>
<p>to help Pizza Place see their data more clearly, analyze their data, and provide insights and recommendations.</p>
<h3>Dataset:</h3>
<p>In this project, it used 3 csv files, orders, order_details, and pizzas, each file is data from 2022 to 2023 and must imported to jupyter notebook</p>
